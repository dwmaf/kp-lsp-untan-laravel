    ...
    <div class="container-fluid px-4 mt-4">
        <div class="row">
            ...
            <div class="col-md-4 my-2">
                <div class="card jadwal">
                    <div class="card-body jadwal-body">
                        <i class="fa-solid fa-map-marker-alt fa-2x mb-3" style="color:#0d6efd"></i>
                        <div class="statistik d-flex align-items-center mb-4">
                            {{-- <h2 class="h2 fw-bolder" style="color:#0a57ca">{{ $jumlah_asesor }}</h2> --}}
                            <h4 class="h4 fw-bolder mx-2"> TUK</h4>
                        </div>
                        <p>Tempat Uji Kompetensi (TUK) adalah tempat kerja atau tempat lainnya yang memenuhi persyaratan untuk digunakan sebagai tempat pelaksanaan uji kompetensi oleh LSP. </p>
                        {{-- <a href="/asesor" class="readmore text-decoration-none">More <i
                                class="fa-solid fa-arrow-right mx-2"></i></a> --}}
                    </div>
                </div>
